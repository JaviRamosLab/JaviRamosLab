# <h1 align="center">Javier Ramos Nistal</h1>

---

## Acerca de mí

Soy desarrollador web estoy trabajando y aprendiendo

**backend**: php, nodejs, laravel, python.

**frontend**: HTML, CCS, JavaScript, React + (jquery, bootstrap,)

**Bases de datos**: MySQL, MongoDB

**Tecnologías**: API (Fetch), 

**Librerias**: jQuery, Axios, D3.js, CanvasConfetti
